(function (global) {
  ...
  var STRINGS = {
    el: {
      ...
      'notify.title': 'Καθημερινή Ειδοποίηση',
      'notify.subtitle': 'Ένα μήνυμα το πρωί με το πιο σημαντικό της ημέρας — τίποτα παραπάνω.',
      'notify.needsAccount': 'Χρειάζεται σύνδεση λογαριασμού πρώτα (δες Backup).',
      'notify.enable': 'Ενεργοποίηση ειδοποίησης',
      'notify.hourLabel': 'Ώρα ειδοποίησης',
      'notify.statusEnabled': 'Ενεργή — {hour}:00',
      'notify.statusDisabled': 'Ανενεργή',
      'notify.permissionDenied': 'Το κινητό σου έχει μπλοκάρει τις ειδοποιήσεις. Ενεργοποίησέ τες από τις ρυθμίσεις της συσκευής.',
      'notify.error': 'Κάτι πήγε στραβά. Δοκίμασε ξανά.',
      'notify.unsupported': 'Οι ειδοποιήσεις δεν υποστηρίζονται σε αυτή τη συσκευή/browser.',
      ...
      'account.title': 'Λογαριασμός & Συγχρονισμός',
      'account.notConfigured': 'Ο συγχρονισμός δεν έχει ρυθμιστεί ακόμα.',
      'account.emailPlaceholder': 'π.χ. you@email.com',
      'account.sendLink': 'Αποστολή link σύνδεσης',
      'account.checkEmail': 'Έλεγξε το email σου για το link σύνδεσης.',
      'account.signedInAs': 'Συνδεδεμένος ως',
      'account.signOut': 'Αποσύνδεση',
      'account.syncing': 'Συγχρονισμός...',
      'account.synced': 'Συγχρονισμένο',
      'account.syncError': 'Σφάλμα συγχρονισμού',
      'account.invalidEmail': 'Βάλε ένα έγκυρο email.',
    ...
    it: {
      ...
      'notify.title': 'Notifica giornaliera',
      'notify.subtitle': 'Un messaggio al mattino con la cosa più importante della giornata — niente di più.',
      'notify.needsAccount': 'Serve prima l’accesso all’account (vedi Backup).',
      'notify.enable': 'Attiva notifica',
      'notify.hourLabel': 'Ora della notifica',
      'notify.statusEnabled': 'Attiva — {hour}:00',
      'notify.statusDisabled': 'Disattivata',
      'notify.permissionDenied': 'Il tuo dispositivo ha bloccato le notifiche. Attivale dalle impostazioni del dispositivo.',
      'notify.error': 'Qualcosa è andato storto. Riprova.',
      'notify.unsupported': 'Le notifiche non sono supportate su questo dispositivo/browser.',
      ...
      'account.title': 'Account e sincronizzazione',
      'account.notConfigured': 'La sincronizzazione non è ancora configurata.',
      'account.emailPlaceholder': 'es. tu@email.com',
      'account.sendLink': 'Invia link di accesso',
      'account.checkEmail': 'Controlla la tua email per il link di accesso.',
      ...
      'account.syncError': 'Errore di sincronizzazione',
      'account.invalidEmail': 'Inserisci un’email valida.',
    ...
    es: {
      ...
      'notify.title': 'Notificación diaria',
      'notify.subtitle': 'Un mensaje por la mañana con lo más importante del día — nada más.',
      'notify.needsAccount': 'Necesitas iniciar sesión primero (ver Backup).',
      'notify.enable': 'Activar notificación',
      'notify.hourLabel': 'Hora de la notificación',
      'notify.statusEnabled': 'Activa — {hour}:00',
      'notify.statusDisabled': 'Desactivada',
      'notify.permissionDenied': 'Tu dispositivo ha bloqueado las notificaciones. Actívalas desde los ajustes del dispositivo.',
      'notify.error': 'Algo salió mal. Inténtalo de nuevo.',
      'notify.unsupported': 'Las notificaciones no son compatibles con este dispositivo/navegador.',
      'settings.theme': 'Tema — Sistema',
      ...
      'account.notConfigured': 'La sincronización aún no está configurada.',
      'account.emailPlaceholder': 'ej. tu@email.com',
      'account.sendLink': 'Enviar enlace de acceso',
      'account.checkEmail': 'Revisa tu correo para el enlace de acceso.',
      ...
      'account.invalidEmail': 'Introduce un correo válido.',
    ...
    fr: {
      ...
      'notify.title': 'Notification quotidienne',
      'notify.subtitle': 'Un message le matin avec l’essentiel de la journée — rien de plus.',
      'notify.needsAccount': 'Connexion au compte requise d’abord (voir Backup).',
      'notify.enable': 'Activer la notification',
      'notify.hourLabel': 'Heure de la notification',
      'notify.statusEnabled': 'Active — {hour}:00',
      'notify.statusDisabled': 'Désactivée',
      'notify.permissionDenied': 'Ton appareil a bloqué les notifications. Active-les dans les réglages de l’appareil.',
      'notify.error': 'Une erreur est survenue. Réessaie.',
      'notify.unsupported': 'Les notifications ne sont pas prises en charge sur cet appareil/navigateur.',
      ...
      'account.title': 'Compte et synchronisation',
      'account.notConfigured': 'La synchronisation n’est pas encore configurée.',
      'account.emailPlaceholder': 'ex. toi@email.com',
      'account.sendLink': 'Envoyer le lien de connexion',
      'account.checkEmail': 'Vérifie ton email pour le lien de connexion.',
      'account.signedInAs': 'Connecté en tant que',
      'account.signOut': 'Se déconnecter',
      'account.syncing': 'Synchronisation...',
      'account.synced': 'Synchronisé',
      'account.syncError': 'Erreur de synchronisation',
      'account.invalidEmail': 'Entre un email valide.',
    ...
    en: {
      ...
      'notify.subtitle': 'One morning message with the most important thing today — nothing more.',
      'notify.needsAccount': 'Sign in first (see Backup).',
      'notify.enable': 'Enable notification',
      'notify.hourLabel': 'Notification time',
      'notify.statusEnabled': 'On — {hour}:00',
      'notify.statusDisabled': 'Off',
      'notify.permissionDenied': 'Your device blocked notifications. Enable them in device settings.',
      'notify.error': 'Something went wrong. Try again.',
      'notify.unsupported': 'Notifications aren’t supported on this device/browser.',
      ...
      'account.notConfigured': 'Sync isn’t set up yet.',
      'account.emailPlaceholder': 'e.g. you@email.com',
      'account.sendLink': 'Send sign-in link',
      'account.checkEmail': 'Check your email for the sign-in link.',
